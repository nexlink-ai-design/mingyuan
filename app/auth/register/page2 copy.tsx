          ...
          <div className="w-full space-y-4">
            ...
            <div className="flex items-start gap-2 pt-2">
              <button
                ...
                className={`mt-1 w-4 h-4 rounded-sm border flex items-center justify-center shrink-0 transition-colors ${agreed ? 'bg-[#E05299] border-[#E05299]' : 'bg-white border-gray-400'
                  }`}
              >
